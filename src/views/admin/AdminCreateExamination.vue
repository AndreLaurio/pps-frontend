                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-content>
                            ...
                            <v-card-text class="pl-12 pr-12">
                                ...
                                <v-text-field v-model="exam.exam_title" :counter="50" outlined label="Title" />
                                <v-textarea v-model="exam.exam_desc" :counter="200" outlined label="Description" />
                        ...
                        <v-expansion-panel-content>
                            ...
                            <v-card-text class="pl-12 pr-12">
                                ...
                                <v-card v-for="(item, item_no) in exam.exam_items" :key="item.item_no" class="pa-4 mb-4">
                                    ...
                                    <v-container v-if="item.question_type_code == 'SCQ' || item.question_type_code == 'MCQ'">
                                        <v-divider />
...
export default {
    ...
    methods:{
        ...
        validateIsCorrect(item, choice_no) {
            ...
            if (item.question_type_code == 'SCQ' && item.choices[choice_no].is_correct == true) {
